...
function getCategories() {
    return __awaiter(this, void 0, void 0, function* () {
        let url = "https://www.confrerie-des-traducteurs.fr/api/skyrim/categories";
        try {
...
function getSubCategories(id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let json = yield response.json();
            let subCategories = [];
            json.ChildCategories.forEach((element) => {
                subCategories.push({
                    id: element.Id,
                    name: element.Name,
                    description: element.Description,
...
function getModById(modId) {
    return __awaiter(this, void 0, void 0, function* () {
        let url = `https://www.confrerie-des-traducteurs.fr/api/skyrim/mods/${modId}`;
        try {
            let response = yield fetch(url);
            if (!response.ok)
                throw new Error('Impossible de récupérer le mod : ' + response.status);
            let mod = yield response.json();
            return mod;
        }
        catch (error) {
            console.error('Erreur:', error);
...
const MyMainPage = () => {
    ...
    React.useEffect(() => {
        ...
        const loadCategories = () => __awaiter(void 0, void 0, void 0, function* () {
            const fetchedCategories = yield getCategories();
            setCategories(fetchedCategories);
        });
        loadCategories();
    }, []);
    const handleCategoryClick = (cat) => __awaiter(void 0, void 0, void 0, function* () {
        if (cat.subCategory) {
            const fetchedSubCategories = yield getSubCategories(cat.id);
            setSubCategories(fetchedSubCategories);
            setParentCategory(cat);
        }
        else {
            setSelectedCategory(cat);
            const mods = yield getModsForCategory(cat.id);
            setModsForCategory(mods);
        }
    });
    const handleModClick = (mod) => __awaiter(void 0, void 0, void 0, function* () {
        const fetchedMod = yield getModById(mod.id);
        setMod(fetchedMod);
    });
    ...
    const rows = (subCategories.length > 0 ? subCategories : categories).map((cat) => React.createElement('div', { className: 'grid-item', key: cat.id }, React.createElement('div', { className: 'card' }, React.createElement('div', { className: 'card-body' }, React.createElement('div', { className: 'card-header' }, React.createElement('img', { className: 'card-image', src: cat.imageUrl }), React.createElement('h5', { className: 'card-title' }, cat.name)), React.createElement('p', { className: 'card-content' }, cat.description)), React.createElement('button', {
        type: 'button',
        className: 'card-link',
        onClick: () => handleCategoryClick(cat)
    }))));
    const mods = modsForCategory.map((mod) => React.createElement('div', { className: 'grid-item grid-5', key: mod.id }, React.createElement('div', { className: 'card' }, React.createElement('div', { className: 'card-body mod' }, React.createElement('div', { className: 'card-header' }, React.createElement('img', { className: 'card-image', src: mod.image }), React.createElement('h5', { className: 'card-title' }, mod.name)), React.createElement('p', { className: 'card-content', dangerouslySetInnerHTML: { __html: mod.description } }), React.createElement('div', { className: 'card-footer' }, React.createElement('p', {}, 'Mod de ' + mod.authors.map((a) => a.Name).join(', ')), React.createElement('p', {}, 'Traduit par ' + mod.translators.map((t) => t.Name).join(', ')))), React.createElement('button', {
        type: 'button',
        className: 'card-link',
        onClick: () => handleModClick(mod)
    }))));
    if (mod) {
        return React.createElement('div', { className: 'main' }, React.createElement('div', { className: 'header' }, React.createElement('div', {
            ...
            React.createElement('a', {
                ...
                target: '_blank'
            }, a.Name, a.index < mod.Authors.length - 1 ? ', ' : '')
        ])))), React.createElement('nav', { className: 'header-breadcrumb' }, React.createElement('ol', {}, (selectedCategory || mod) &&
            ...
            }, parentCategory.name), parentCategory && selectedCategory &&
            React.createElement('li', {
                className: 'breadcrumb-item',
                onClick: () => {
                    setMod(null);
                },
            }, selectedCategory.name), mod &&
            React.createElement('li', {
            ...
            }, mod.Name))), React.createElement(react_slick_1.default, {
            style: {
                padding: '10px 50px'
            },
            dots: true,
        ...
        }, React.createElement('h2', null, 'Images du mod'), React.createElement('div', {
            style: {
                display: 'flex',
                flexWrap: 'wrap',
                gap: '10px',
        ...
        }, sortedImages(mod).map((img, i) => React.createElement('img', {
            key: `modal-image-${i}`,
            src: img.Link,
            alt: `Image ${i + 1}`,
        ...
        return React.createElement('div', { className: 'main' }, React.createElement('h1', { className: 'text-center' }, 'Bienvenue sur l\'extension de la Confrérie des Traducteurs'), React.createElement('h2', { className: 'text-center' }, subTitle), React.createElement('div', { className: 'grid-container' }, React.createElement('div', { className: 'grid grid-5' }, modsForCategory.length > 0 ? mods : rows)), ((subCategories.length > 0 || modsForCategory.length > 0) && categories.length > 0) &&
            React.createElement('button', {
...
function main(context) {
    context.registerMainPage('search', 'Confrérie', MyMainPage, {
        id: 'confrerie-main-page',
        group: 'per-game',
        visible: () => true
    });
    return true;
